  ...
  return (
    <div className="min-h-screen w-full bg-creator-bg text-creator-text overflow-hidden">
      <section className="min-h-screen w-full flex flex-col lg:flex-row">
        ...
        {/* ================= RIGHT ================= */}
        {/* ================= RIGHT (SELLER REGISTER PANEL) - FIXED HEIGHT & NO SCROLL ================= */}
        <div className="w-full lg:w-1/2 h-auto lg:h-screen flex items-center justify-center px-4 sm:px-8 py-6 lg:py-0 border-t-[1px] lg:border-t-0 lg:border-l-[1px] border-creator-accent relative bg-creator-bg overflow-hidden">
            ...
            className="space-y-2.5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  {/* Click hone par state ko toggle karega (true <-> false) */}
                  <span
              ...
              <div className="pt-1">
                <button
                  ...
                  type="submit"
                  className="w-full bg-[#1A2E26] hover:bg-neutral-800 text-white py-2.5 rounded-xl text-xs font-medium transition-all duration-300 tracking-wide"
                >
                  {isLoading
                    ? isLogin
                      ? "Signing in..."
